...
HX8357_t4x_p lcd = HX8357_t4x_p(10, 8, 9);  //(dc, cs, rst)
#else
HX8357_t4x_p lcd = HX8357_t4x_p(4, 5, 3);  //(dc, cs, rst)
#endif
...
void setup() {
  ...
  */
    ...
    lcd.begin(HX8357X, HX8357X_SPEED_MHX);
    lcd.setBitDepth(16);
    test_display();
    lcd.setRotation(3);
...
unsigned long testText() {
    ...
    lcd.setTextColor(HX8357_YELLOW);
    lcd.setTextSize(2);
    lcd.println(1234.56);
    lcd.setTextColor(HX8357_RED);
    lcd.setTextSize(3);
...
void test_display() {
    ...
    delay(500);
    lcd.fillScreen(HX8357_GREEN);
    delay(500);
    lcd.fillScreen(HX8357_BLUE);
    delay(500);
    lcd.fillScreen(HX8357_BLACK);
    delay(500);
    lcd.setRotation(0);
